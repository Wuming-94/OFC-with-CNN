function [proj_xy, proj_yz, proj_xz] = pyVP(obj, resolution)
...
% Convert to micrometers
    ...
    % margin = 1;
    a = obj.a * Scale;
    center = [obj.v.X,obj.v.Y,obj.v.Z].* Scale; %[μm]
    dir = [obj.v.Vx,obj.v.Vy,obj.v.Vz].* Scale; %1x3
    ...
    R_theta = eye(3) + sin(obj.psi)*K + (1 - cos(obj.psi))*K^2;
