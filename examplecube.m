...
exampletitle('DEFINITION OF PARTICLECube')
...
examplecode('v= Vector(5e-6,0,0,0,0,2.5e-6);')
examplecode('psi=0;')
% examplecode('nm = 1;')
% examplecode('np = 1.5;')
examplecode('bead = ParticleCube(v,psi, nm, np)')
examplewait()
...
% examplecode('bg = BeamGauss(Ex0,Ey0,w0,L,Nphi,Nr);')
