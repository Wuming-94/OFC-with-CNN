function [proj_xy, proj_yz, proj_xz] = cuVP2(obj, resolution)
...
L = 2 * obj.v.norm() * Scale;
center = [obj.v.X, obj.v.Y, obj.v.Z];
...
% end
% 
% K = [0 -dir_unit(3) dir_unit(2); dir_unit(3) 0 -dir_unit(1); -dir_unit(2) dir_unit(1) 0];
